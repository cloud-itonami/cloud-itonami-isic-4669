# Operator Quickstart — Wholesale of waste and scrap and other products n.e.c.

Shortest path from clone to a verified local dry-run for **ISIC 4669** (`cloud-itonami-isic-4669`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4669.git
cd cloud-itonami-isic-4669
```
...
- Blueprint governor key: `waste-trading-governor`
- Likely source path: `wastetrade.governor.cljc`
