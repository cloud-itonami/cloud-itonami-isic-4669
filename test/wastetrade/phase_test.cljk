...
(deftest delivery-dispatch-never-auto-at-any-phase
  (testing "structural invariant: no phase, now or in any future entry, auto-commits a real waste/scrap-across-a-border dispatch"
...
(deftest invoice-settle-never-auto-at-any-phase
  (testing "structural invariant: no phase, now or in any future entry, auto-commits a real waste-trade invoice settlement"
    (doseq [[n {:keys [auto]}] phase/phases]
